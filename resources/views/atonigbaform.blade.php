...
label {
  ...
  <form method='post' action="{{Route('saveatonigbaform')}}" enctype='multipart/form-data'>@csrf
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name='email' class="form-control mb-3" id="inputEmail4" placeholder="Email Address">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
      ...
      <select name='category' id="inputState" class="form-control mb-3">
        ...
        <option value='Properties Issue'>Properties Issue</option>
      </select>
    </div><div class="form-group col-md-6">
    <label for="inputAddress2">Message</label>
    <input type="text" name='message' class="form-control mb-3" id="inputAddress2" >
  </div>
  ...
  <div class="form-group col-md-6">
    <div class="form-check">
      ...
      <label class="form-check-label mb-4" for="gridCheck">
         Please confirm that you accept all <a href='#'>terms and conditions</a> on Atonigba
        <br>Also note that you need to visit our head office at No 4,beside Frontline Hotel,Oluwo Road to complete your application 
        </label><br>
    </div>
