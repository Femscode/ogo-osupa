            ...
            <div class="sidebar-inner slimscrollleft">
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href="#" class="waves-effect"><i class="dripicons-home"></i> <span>Dashboard <span
                                        class="badge badge-success badge-pill float-right">3</span></span></a></li>
                        <li class="has_sub"><a href="javascript:void(0);" class="waves-effect"><i
                                    class="dripicons-briefcase"></i> <span>Investors </span><span
                        ...
                        <li class="has_sub"><a href="javascript:void(0);" class="waves-effect"><i
                                    class="dripicons-archive"></i> <span>Manage </span><span
                                    class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            <ul class="list-unstyled">
                        ...
                        {{-- <li class="has_sub"><a href="javascript:void(0);" class="waves-effect"><i
                                    class="dripicons-document"></i><span> Profile</span><span
                                    class="badge badge-warning badge-pill float-right"><i
                ...
                <div class="topbar">
                    ...
                    <nav class="navbar-custom">
                        ...
                        <div class="search-wrap" id="search-wrap">
                            <div class="search-bar"><input class="search-input" type="search" placeholder="Search"> <a
                                    href="#" class="close-search toggle-search" data-target="#search-wrap"><i
                                        class="mdi mdi-close-circle"></i></a></div>
                        </div>
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list"><a
                                    ...
                                    href="#" role="button" aria-haspopup="false" aria-expanded="false"><i
                                        ...
                                        class="badge badge-danger badge-pill noti-icon-badge">3</span></a>
                                <div
                                    ...
                                    <!-- All--><a href="javascript:void(0);" class="dropdown-item notify-all">View
                                        All</a>
                                </div>
                            </li>
                            <li class="list-inline-item dropdown notification-list nav-user">
                                <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown"
                                    href="#" role="button" aria-haspopup="false" aria-expanded="false"><span
                                        class="d-none d-md-inline-block ml-1">{{Auth::user()->name}} <i
                                            class="mdi mdi-chevron-down"></i></span></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                    <a class="dropdown-item" href="#"><i class="dripicons-user text-muted"></i>
                                        Profile</a> 
                                        {{-- <a class="dropdown-item" href="#"><i
                                            class="dripicons-wallet text-muted"></i> My Wallet</a>
                                    <a class="dropdown-item" href="#"><span
                                            class="badge badge-success float-right m-t-5">5</span><i
                                            class="dripicons-gear text-muted"></i> Settings</a> <a class="dropdown-item"
                                        href="#"><i class="dripicons-lock text-muted"></i> Lock screen</a> --}}
                                    <div  class="dropdown-divider"></div><a href='/logout' onclick='return confirm("Are you sure you want to sign out?");' class="dropdown-item"><i
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list d-none d-sm-inline-block"><a
                                    class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown"
                                    href="#" role="button" aria-haspopup="false" aria-expanded="false">Create New <i
                                        class="mdi mdi-plus"></i></a>
                                <div class="dropdown-menu dropdown-menu-animated"><a class="dropdown-item"
                            ...
                            <li class="list-inline-item notification-list d-none d-sm-inline-block"><a href="#"
                                    class="nav-link waves-effect">Activity</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- Top Bar End -->
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary mini-stat text-white">
                                    <div class="p-3 mini-stat-desc">
                                        <div class="clearfix">
                                            <h6 class="text-uppercase mt-0 float-left text-white-50">Plan for Tommorrow
                                            </h6>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <form method='post'
                                                            action='{{route("createPrice",[$prices->id])}}'>@csrf
                                                            <th scope="row">{{++$key}}</th>
                                                            <td><input type='text' name='plan' class='form-control'
                                                                    value='{{$prices->plan ?? ""}}'></td>
                                                            <td><input type='number' name='investment_amount'
                                                                    class='form-control'
                                                            ...
                                                            <td><input type='text' name='weekly' class='form-control'
                                                                    value='{{$prices->weekly ?? ""}}'></td>
                                                            <td>
                                                                <button type='submit'
                                                                    class='fa fa-call btn btn-success'>Update</button>
                                                            </td>
                                                        </form>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class='fa fa-trash btn btn-success'><a
                                                                    style='color:white'
